**PointShopVR: Immersive Authoring of Large Point Clouds in Virtual Reality**（Currently we publish a test version of code, we will refine this repo in next weeks, thank you very much）
...
3. in the subfolder "projects", git clone [https://github.com/sgumhold/cgv/tree/develop], please choose develop branch.
...
8. git clone "Immersive_labeling_pc" from current repo: https://github.com/lintianfang/PointShopVR
